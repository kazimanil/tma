...
ologit_2017_results <- summary(glm(hap_binary ~ sex + age + age2 + mars + jobs + mat + sh + hos + dis + lyp + lyn + lym + fsp, data = ologit_2017, family = "binomial"))
ologit_2016_results <- summary(glm(hap_binary ~ sex + age + age2 + mars + jobs + mat + sh + hos + dis + lyp + lyn + lym + fsp, data = ologit_2016, family = "binomial"))
ologit_2015_results <- summary(glm(hap_binary ~ sex + age + age2 + mars + jobs + mat + sh + hos + dis + lyp + lyn + lym + fsp, data = ologit_2015, family = "binomial"))
